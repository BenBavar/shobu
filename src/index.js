...
function Game(props) {
  ...
  /* const [firstMoveOver, setFirstMove] = useState(false)

  const setFM = () => {
    setFirstMove(!firstMoveOver)
  }

  const getFM = () => {
    return firstMoveOver
  } */
  ...
  /* if(passive && firstMoveOver) {
    let statusObj = document.getElementsByClassName('statusObj')
    statusObj[0].animate(
        [
            {transform: ''},
            {transform: 'translateY(-20px)', boxShadow: '10px 20px 70px 60px blue', offset: .5},
            {transform: 'translateY(-20px) rotate(5deg)', boxShadow: '10px 20px 70px 60px blue', offset: .55},
            {transform: 'translateY(-20px) rotate(-5deg)', boxShadow: '10px 20px 70px 60px blue', offset: .65},
            {transform: 'translateY(-20px) rotate(0)', boxShadow: '10px 20px 70px 60px blue', offset: .7},
            {transform: '', boxShadow: ''}
        ], 1500)
  } */
          ...
          <div className='inWhole'>
            <div>
              ...
              <div className='grid' style={{transform: 'translateY(-10px)'}}>
                <Board className='board1' setBoardColor={setBC} getBoardColor={getBC} /* setFirstMove={setFM} getFirstMove={getFM} */ setMap={setM} getAllMaps={getAllM} setSquares={setS} getAllSquares={getAllS} setPassive={setP} getPassive={getP} setDisp={setD} getDisp={getD} />
                <Board className='board2' setBoardColor={setBC} getBoardColor={getBC} /* setFirstMove={setFM} getFirstMove={getFM} */ setMap={setM} getAllMaps={getAllM} setSquares={setS} getAllSquares={getAllS} setPassive={setP} getPassive={getP} setDisp={setD} getDisp={getD} />
                <Board className='board3' setBoardColor={setBC} getBoardColor={getBC} /* setFirstMove={setFM} getFirstMove={getFM} */ setMap={setM} getAllMaps={getAllM} setSquares={setS} getAllSquares={getAllS} setPassive={setP} getPassive={getP} setDisp={setD} getDisp={getD} />
                <Board className='board4' setBoardColor={setBC} getBoardColor={getBC} /* setFirstMove={setFM} getFirstMove={getFM} */ setMap={setM} getAllMaps={getAllM} setSquares={setS} getAllSquares={getAllS} setPassive={setP} getPassive={getP} setDisp={setD} getDisp={getD} />
              </div>
            </div>
